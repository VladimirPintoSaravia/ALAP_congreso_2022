...
-------------+---------------------------------------------------------------
           . |      4,248  -1606.348  -1567.324       6   3146.649   3184.774
-----------------------------------------------------------------------------
...
/*
       ...
       Model |          N   ll(null)  ll(model)      df        AIC        BIC
-------------+---------------------------------------------------------------
           . |      4,248  -1606.348   -1561.86       6   3135.719   3173.844
-----------------------------------------------------------------------------
...
-----------------------------------------------------------------------------
       Model |          N   ll(null)  ll(model)      df        AIC        BIC
-------------+---------------------------------------------------------------
           . |      4,248  -1606.348   -1567.26       7    3148.52       3193
-----------------------------------------------------------------------------
...
***Modelo basal interactuado por condición étnica - Odds Ratio
logit covid i.afiliacion_salud ///
	i.sex ///
	i.condicion_laboral ///
	i.urban, or
estat ic
...
**# Bookmark #29
*********************************************************************
**************MODEL 5: COMPLETAMENTE INTERACTUADO********************
*********************************************************************
